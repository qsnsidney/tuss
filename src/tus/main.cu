...
auto parse_args(int argc, const char *argv[])
{
    ...
    option_group("wid", "vertical dimension of a 2D thread block", cxxopts::value<int>()->default_value("256"));
    option_group("lur", "loop unrolling factor", cxxopts::value<int>()->default_value("1024"));
